...
#ifndef _UNN_LMODE_H_
#define _UNN_LMODE_H_
...
// process:
// cbuff contains clines of raw code
// bl_render parses current code and updates clines' coloring
